...
**Далі в черзі — три плани написані, робота не почата** (2026-09-10):

| Стадія | План | Про що |
|--------|------|--------|
| 12 — «Доставка без стрічки» | [plans/stage12_delivery.md](plans/stage12_delivery.md) | конвеєр зносимо; у кожного цеху приймальний ящик і ящик відвантаження |
...
Порядок несучий: 12 приносить два нових об'єкти, 13 дає чим їх намалювати, 14
додає кімнати вже в чистий світ. Навпаки — це малювати той самий арт двічі.
