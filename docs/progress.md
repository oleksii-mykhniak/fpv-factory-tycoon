...
**Далі в черзі — два плани написані, робота не почата** (2026-09-11):
...
| 15 — «Один набір кольорів» | [plans/stage15_palette.md](plans/stage15_palette.md) | палітра дістає ролі, квантизація стає безумовною, сирий колір у генераторі ламає тест |

Стадія 15 — хвіст Стадії 13: єдиний крок пайплайну, який лишився вимкненим.
Вимірка (у плані) каже, що вона обмежена згори — 24 файли з 80, решта вже
чисті. Порядок із 14 неважливий: вони не перетинаються.
