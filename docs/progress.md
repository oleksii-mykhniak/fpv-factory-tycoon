...
**Чекає валідації на залізі.** Три останні стадії зроблені й закомічені, але на
...
**Далі в черзі — два плани написані, робота не почата** (2026-09-10):

| Стадія | План | Про що |
|--------|------|--------|
| 13 — «Нуль емодзі на сцені» | [plans/stage13_art.md](plans/stage13_art.md) | усе на сцені — згенерований спрайт; генератор стає пайплайном |
...
Порядок несучий: 12 принесла два нових об'єкти (приймальний ящик і ящик
відвантаження), 13 дає чим їх намалювати, 14 додає кімнати вже в чистий світ.
Навпаки — це малювати той самий арт двічі.
