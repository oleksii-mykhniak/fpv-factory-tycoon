...
**Стадія 14 «Фабрика з кімнатами» — К1–К5 зроблені** ([план](plans/stage14_rooms.md),
[факти](progress/stage14_rooms.md)). Фабрика росте сімома кімнатами п'яти типів:
три цехи, лабораторія, відділ контрактів, майданчик обльоту, склад. На залізі
не перевірено — і перевірити тут є що більше, ніж у будь-якій стадії до неї.
...
додає кімнати вже в чистий світ, а не малює той самий арт двічі.
