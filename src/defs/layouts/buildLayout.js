...
// пікселів завезеного арту), тому й місце під неї квадратне. Було 0.70×0.46 —
// пропорція намальованого генератором прямокутника; новий арт у ній сплющувався
// в кришку без боків.
//
// `boxOpen` — та сама коробка, розгорнута на столі. Ширша за високу двічі, хоч
// сама розгортка має 1.5:1: вона лежить, а не стоїть, і ракурс її вкорочує.
export const SIZES = {
  character: u(1),
  box:       { w: u(0.62), h: u(0.60) },
  boxOpen:   { w: u(0.96), h: u(0.48) },
