...
export const QUEST_ACTS = Object.freeze([
...

  {
    ...
    steps: [
      ...
      {
        // Дошка, а не сам працівник (Стадія 11 / D3): підвищення переїхало в
        // ту саму панель, де беруть людей.
        id: 'promote_any', kind: 'do', zoneKind: 'jobboard',
        why: 'Дошка оголошень · секція «Ваші люди»',
